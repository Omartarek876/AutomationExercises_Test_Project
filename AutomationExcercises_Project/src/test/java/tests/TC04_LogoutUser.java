...
public class TC04_LogoutUser {
    ...
    public void TC02_ValidLogin(LoginUsers validLoginUsers) {
        ...
        Homepage.LogOut();      
        assertTrue(validLogin_Page.LoginHeader().contains("Login to your account") , "the user is navigated to a wrong direction");
        System.out.println("the user logout successfully");
